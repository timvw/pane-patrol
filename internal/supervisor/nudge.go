...
// -l for literals).
//
// NOTE: This uses strings.Fields, which collapses runs of whitespace
// and trims leading/trailing spaces. A literal text payload containing
// spaces (e.g., "hello world") would be split into separate
